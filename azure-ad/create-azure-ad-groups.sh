...
# TODO: Turn this into a helm chart with a value for $CLUSTER_ADMIN_GROUP_OBJECT_ID (and metadata.name and possible others)
# In fact delete the folder k8s-rbac/ and don't ever use kubectl apply
